 ...
 * @generated
 */
public class MetamodelFactoryImpl extends EFactoryImpl implements EAM_MetamodelFactory {
	/**
	 ...
	 * @generated
	 */
	public static EAM_MetamodelFactory init() {
		try {
			EAM_MetamodelFactory theMetamodelFactory = (EAM_MetamodelFactory) EPackage.Registry.INSTANCE
					.getEFactory(EAM_MetamodelPackage.eNS_URI);
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		...
		case EAM_MetamodelPackage.APPLICATION_TYPE:
	 ...
	 * @generated
	 */
	public EAM_Product createProduct() {
	 ...
	 * @generated
	 */
	public EAM_Application createApplication() {
	 ...
	 * @generated
	 */
	public EAM_DataCenter createDataCenter() {
	 ...
	 * @generated
	 */
	public EAM_Landscape createLandscape() {
	 ...
	 * @generated
	 */
	public EAM_MetamodelPackage getMetamodelPackage() {
		return (EAM_MetamodelPackage) getEPackage();
	}
	 ...
	 */
	@Deprecated
	public static EAM_MetamodelPackage getPackage() {
		return EAM_MetamodelPackage.eINSTANCE;
	}
